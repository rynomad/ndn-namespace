...
<head>
  <meta charset="utf-8">
  <title>Plato - src/Transports/AbstractTransport.js</title>
...
<div class="jumbotron">
  <div class="container">
    <h1>src/Transports/AbstractTransport.js</h1>
  </div>
</div>
...
<div class="container">
  <div class="row">
    <textarea id="file-source" class="col-md-12">/**An Abstract transport class for unit testing the {@link Interfaces} data structure and a starting point for implimenting new Transports
 *@constructor
 */
...
module.exports = AbstractTransport;</textarea>
  </div>
</div>
